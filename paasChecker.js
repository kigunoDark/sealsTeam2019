var passChecker = (function(){
    ...
    var i18n = {
        ...
        publicWarn: '— данная комбинация часто встречается в публичных списках паролей',
        sec1: 'секунда', sec2: 'секунды', sec3: 'секунд',
        min1: 'минута', min2: 'минуты', min3: 'минут',
        hour1: 'час', hour2: 'часа', hour3: 'часов',
        day1: 'день', day2: 'дня', day3: 'дней',
        year1: 'год', year2: 'года', year3: 'лет',
        infinity: 'бесконечность'
    };

    var reasonElem, publicWarnElem, checkerBlock, resultBlock, durationElem, timeMsgElem;
